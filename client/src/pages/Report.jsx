...
export default function Report() {
    ...
    return (
        <div className='bg-gray-100 min-h-screen flex flex-col justify-center items-center p-6'>
            ...
            <div className="sm:p-2 md:p-6 bg-[#F0F7FF] shadow-md rounded-md md:h-[530px]">
                ...
                <div className="w-full h-10 grid grid-cols-5 gap-x-4 bg-[#F1F1F1] mt-4 border-2 border-[#D9D9D9]">
                    ...
                    <span className='col-span-2 text-end sm:text-sm md:text-lg'>Name</span>
                    <span className='col-span-1 sm:text-sm md:text-lg rounded-md  text-start w-16 h-10'>Status</span>
                </div>
                <div className="md:overflow-y-scroll w-full md:h-[300px] mt-4">
                    {students.map((std, index) => (
                        <div key={index} className="grid grid-cols-5 h-16 gap-x-4 p-6">
                            ...
                            <span className='col-span-2 sm:text-sm md:text-lg text-end'>{std.name}</span>
                            <span className='col-span-1 sm:text-sm md:text-lg bg-[#E5FFF7] p-2 text-[#0CBC8B] w-16 rounded-md text-start h-10'>Present</span> 
                        </div>
                    ))}
                </div>
                </div>
